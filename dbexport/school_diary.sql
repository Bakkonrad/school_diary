...
--
-- Host: 127.0.0.1
-- Czas generowania: 17 Maj 2023, 18:25
...
--
ALTER TABLE `grades`
  ADD CONSTRAINT `grades_ibfk_1` FOREIGN KEY (`added_by`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `grades_ibfk_2` FOREIGN KEY (`grade`) REFERENCES `types_of_grades` (`id`),
  ADD CONSTRAINT `grades_ibfk_3` FOREIGN KEY (`subject`) REFERENCES `subjects` (`id`);

--
-- Ograniczenia dla tabeli `subjects`
--
ALTER TABLE `subjects`
  ADD CONSTRAINT `subjects_ibfk_1` FOREIGN KEY (`teacher`) REFERENCES `users` (`id`),
...
--
ALTER TABLE `users`
  ADD CONSTRAINT `users_ibfk_1` FOREIGN KEY (`class`) REFERENCES `classes` (`class_id`),
  ADD CONSTRAINT `users_ibfk_2` FOREIGN KEY (`role`) REFERENCES `roles` (`role_id`),
  ADD CONSTRAINT `users_ibfk_3` FOREIGN KEY (`id`) REFERENCES `grades` (`student`);
COMMIT;
